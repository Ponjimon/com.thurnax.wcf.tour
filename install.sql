...
-- optionals
	...
	ctaLabel       VARCHAR(255)                           NULL DEFAULT NULL,

-- callbacks
	onPrev         MEDIUMTEXT                             NULL DEFAULT NULL,
	onNext         MEDIUMTEXT                             NULL DEFAULT NULL,
	onShow         MEDIUMTEXT                             NULL DEFAULT NULL,
	onCTA          MEDIUMTEXT                             NULL DEFAULT NULL,
...
/* foreign keys */
ALTER TABLE wcf1_tour ADD FOREIGN KEY (packageID) REFERENCES wcf1_package (packageID)
	ON DELETE CASCADE;
ALTER TABLE wcf1_tour_step ADD FOREIGN KEY (tourID) REFERENCES wcf1_tour (tourID)
	ON DELETE CASCADE;
ALTER TABLE wcf1_tour_step ADD FOREIGN KEY (packageID) REFERENCES wcf1_package (packageID)
	ON DELETE CASCADE;
ALTER TABLE wcf1_tour_user ADD FOREIGN KEY (tourID) REFERENCES wcf1_tour (tourID)
	ON DELETE CASCADE;
ALTER TABLE wcf1_tour_user ADD FOREIGN KEY (userID) REFERENCES wcf1_user (userID)
	ON DELETE CASCADE;
